...
*/
    ...
    */
     ...
     */
    public static String createUUID(){ return  UUID.randomUUID().toString(); }
     ...
     */
    public static UUID toUUID(String uuid){return UUID.fromString(uuid); }
     ...
     * @return java.util.UUID.
     */
    public static UUID toUUID(byte[] uuid){return UUID.nameUUIDFromBytes(uuid); }
