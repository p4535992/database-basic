...
import datasource.context.DatabaseContextFactory;
import datasource.context.LocalContext;
import datasource.context.LocalContextFactory;
import datasource.sql.SQLUtilities;
...
public class DataSourceFactory {
    ...
    public static DataSource createDataSource(
            String dataSourceName,String jdbcUrl,Enumerator.DBDriver dbDriver,
            String username,String password) {
    ...
    public static DataSource createDataSourceWithBoneCP(Enumerator.DBDriver dbDriver,String url, String username, String password){
